...
///
/// Security approach:
/// - Whitelist-based: Only allows known-safe tags and attributes
...
@objc public final class FabricHTMLSanitizer: NSObject {
  ...
  /**
   * Custom whitelist configured with our security policy.
   */
  ...
  @objc public func sanitize(_ html: String) -> String {
    ...
    do {
      ...
      var clean = try SwiftSoup.clean(normalized, "", whitelist, outputSettings) ?? ""
